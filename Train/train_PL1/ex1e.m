...
%e) Altere o gerador de palavras aleatorias para considerar um 
% novo parametro de entrada n que representa 
% o tamanho maximo da palavra (em numero de letras) das palavras geradas 
% (ou seja, o gerador de palavras para se atingir o estado '.'  
% ou se ja tiver gerado n letras).
...
%f) Para n = 8,6 e 4 simula a geração de 10^5 palavras aleatorias para
% estimar o numero de palavras diferentes geradas e a probabilidade de uma
% palavra gerada ser uma palavra valida em portugues
